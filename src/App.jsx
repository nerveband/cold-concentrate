...
const ColdBrewCalculator = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-gradient-to-br from-amber-50 to-orange-50 min-h-screen">
      {/* Phase Toggle */}
      ...
      {phase === 'prepare' && (
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center gap-3 mb-6">
            <Beaker className="text-amber-600" size={32} />
            <h1 className="text-3xl font-bold text-gray-800">Step 1: Prepare Your Concentrate</h1>
          </div>

          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-3">What do you want to control?</label>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-3">Concentrate Strength</label>
                <select
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    min="1"
                  />
                  <span className="absolute right-3 top-2.5 text-gray-500">ml</span>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-amber-50 p-4 rounded-lg border-l-4 border-amber-600">
                <h3 className="font-bold text-amber-800 mb-3">Your Concentrate Recipe</h3>
              ...
              <div className="bg-orange-50 p-4 rounded-lg border-l-4 border-orange-600">
                <h3 className="font-bold text-orange-800 mb-2">Roast Notes</h3>
                <p className="text-sm text-orange-700">{roastAdjustments[roastLevel].notes}</p>
              </div>
      ...
      {phase === 'serve' && (
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-800">Step 2: Serve Your Cold Brew</h1>
          </div>

          {savedConcentrateRatio && (
            <div className="bg-green-50 p-4 rounded-lg mb-6 border-l-4 border-green-600">
              <h3 className="font-bold text-green-800 mb-2">Your Concentrate Info</h3>
          ...
          {!savedConcentrateRatio && (
            <div className="bg-yellow-50 p-4 rounded-lg mb-6 border-l-4 border-yellow-600">
              <h3 className="font-bold text-yellow-800 mb-2">Which concentrate did you make?</h3>
              <select
                onChange={(e) => {
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 p-4 rounded-lg border-2 border-blue-500">
                <h3 className="font-bold text-blue-800 mb-3">📋 Recommended Recipe</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between items-center">
                    <span>Concentrate:</span>
                    <span className="font-bold text-lg text-blue-900">{recommendedConcentrate}ml</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span>Cold Water:</span>
                    <span className="font-bold text-lg text-blue-900">{recommendedWater}ml</span>
                  </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-bold text-gray-800 mb-3">Or Customize:</h3>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-amber-100 to-orange-100 p-6 rounded-lg border-2 border-amber-500">
                <h3 className="font-bold text-amber-900 mb-4 text-xl">🎯 Your Mix</h3>
                <div className="space-y-3">
                  <div className="bg-white p-3 rounded-lg">
                    <div className="text-sm text-gray-600">Add Concentrate</div>
                    <div className="text-3xl font-bold text-amber-900">{concentrateAmount}ml</div>
                  </div>
                  <div className="text-center text-2xl text-amber-700">+</div>
                  <div className="bg-white p-3 rounded-lg">
                    <div className="text-sm text-gray-600">Add Cold Water</div>
                    <div className="text-3xl font-bold text-blue-900">{waterNeeded}ml</div>
                  </div>
                  <div className="text-center text-2xl text-amber-700">=</div>
                  <div className="bg-amber-900 text-white p-3 rounded-lg">
                    <div className="text-sm">Total in Dispenser</div>
                    <div className="text-3xl font-bold">{dispenserCapacity}ml</div>
                  </div>
                </div>
              </div>

              <div className="bg-purple-50 p-4 rounded-lg border-l-4 border-purple-600">
                <h3 className="font-bold text-purple-800 mb-2">Final Dilution</h3>
